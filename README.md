...
## How to run
1. Open `Task Manager/index.html` directly in a browser.
...
## Notes
- The app uses `local Storage`, so tasks remain after refreshing the page.
...
- `git commit -m "implement local Storage persistence"`
